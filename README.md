...
The tagged release v1.0.0 contains `x8_icing_evidence_overview.mp4`, a short explanatory visualization of the manuscript-reported multiplicity, support, cross-method, and propulsion-sensitivity results. The video is explanatory only; it is not an additional inferential evidence layer.

## Version

Manuscript-associated public release: https://github.com/MeteMurat/x8-icing-robustness-identifiability/releases/tag/v1.0.0
